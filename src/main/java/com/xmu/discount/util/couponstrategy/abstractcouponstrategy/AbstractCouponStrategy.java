package com.xmu.discount.util.couponstrategy.abstractcouponstrategy;

import com.xmu.discount.domain.OrderItem;
import com.xmu.discount.util.OrderItemCloneUtil;
        ...
        if (enough) {
            ...
            if (error.compareTo(BigDecimal.ZERO) != 0) {
                ...
                if (!gotIt) {
                    ...
                    newItems.add(item);
                    OrderItem newItem = (OrderItem) OrderItemCloneUtil.clone(item);
                    newItem.setNumber(1);
